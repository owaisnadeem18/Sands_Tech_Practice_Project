...
const ContactForm3 = ({onNext , onBack , totalSteps , step}) => {
  ...
  return (
    <div className="absolute z-20 rounded-4xl bg-pink-50 p-1" style={{ pointerEvents: 'auto' }}>
      <div className="frame-inner rounded-4xl flex w-[90vw] flex-col bg-neutral-50 border border-white/50 backdrop-blur-3xl shadow-[0_0_15px_rgba(0,0,0,0.05)] p-8 sm:w-[32rem] md:p-10">
